...
const OurIdentity = () => {
  return <>
        <div className="py-24">
            <h1 className="sectionName">Our Vision, Mission & Core Values</h1>
            <h1 className="sectionHeader">Our Identity</h1>
            <p className="text-base text-center max-w-2xl mx-auto">At the heart of everything we do is a clear vision, a powerful mission, and strong values that shape our journey and yours.</p>
