...
const ContactUs = () => {
  ...
  <div className="py-20">
      ...
      <div className='flex flex-col sm:flex-row gap-10 min-h-screen w-11/12 mx-auto pb-10' id='contact'>
        <form  ref={form} onSubmit={sendEmail} className="shadow-lg p-4 rounded-lg flex flex-col gap-5 py-14 w-full max-w-2xl">
          ...
          <div className="flex flex-col">
            <label 
            htmlFor="phoneNumber" 
            className="para uppercase font-semibold text-sm mb-2">your phone number (optional)</label>
            <input 
            type="text" 
            id="phoneNumber" 
            name="phonenumber"
      ...
      <div className="max-w-96">
        ...
        <div>
          ...
          <div className="flex flex-col justify-center items-center gap-2 border border-gray-200 p-4 my-5 rounded-lg mx-auto">
              <h1 className="heading-color font-bold text-xl mb-2">Get us on</h1>
