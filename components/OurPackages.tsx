...
const OurPackages = ({packages, button=true}:{packages:packagesType[], button?:boolean}) => {
  return <>
    <div className="flex flex-col items-center justify-center w-full h-full py-24">
      ...
      <h1 className="sectionHeader px-3">Flexible Plans Tailored to Your Needs</h1>
      <p className="text-base text-center px-3">Choose from scalable social media marketing packages designed to fit businesses of all sizes and goals.</p>
